...
for current_index in tqdm(range(60)):
...
filename = f'{expanded_path}/affnist_expanded_train'
res = (imgs, lbls)
...
img_list = []
lbl_list = []
# for ij_cnt in tqdm(range(169)):
ij_cnt = randrange(169)
i = int(ij_cnt/13) -6
j = ij_cnt%13 -6
...
print('Saving the testing set ...')

filename = f'{expanded_path}/affnist_expanded_test'
